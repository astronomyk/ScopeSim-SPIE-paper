...
\title{ScopeSim: A pythonic observatory data simulation framework}

\author[a]{Kieran Leschinski}
\author[b]{HB OC GVK MV WZ}
\affil[a]{Department of Astrophysics - University of Vienna, 
          Tuerkenschanzstrasse 17, Vienna, Austria}
\affil[b]{Kapteyn Institute - University of Groningen}

\authorinfo{Send correspondence to kieran.leschinski@univie.ac.at}
